...
namespace Com.Nhaarman.Listviewanimations.Swinginadapters.Prepared {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='com.nhaarman.listviewanimations.swinginadapters.prepared']/class[@name='SwingBottomInAnimationAdapter']"
	[global::Android.Runtime.Register ("com/nhaarman/listviewanimations/swinginadapters/prepared/SwingBottomInAnimationAdapter", DoNotGenerateAcw=true)]
	public partial class SwingBottomInAnimationAdapter : global::Com.Nhaarman.Listviewanimations.Swinginadapters.SingleAnimationAdapter {

		internal static new IntPtr java_class_handle;
		internal static new IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("com/nhaarman/listviewanimations/swinginadapters/prepared/SwingBottomInAnimationAdapter", ref java_class_handle);
			}
		}
		...
		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.nhaarman.listviewanimations.swinginadapters.prepared']/class[@name='SwingBottomInAnimationAdapter']/constructor[@name='SwingBottomInAnimationAdapter' and count(parameter)=1 and parameter[1][@type='android.widget.BaseAdapter']]"
		[Register (".ctor", "(Landroid/widget/BaseAdapter;)V", "")]
		public SwingBottomInAnimationAdapter (global::Android.Widget.BaseAdapter p0) : base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
		...
		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.nhaarman.listviewanimations.swinginadapters.prepared']/class[@name='SwingBottomInAnimationAdapter']/constructor[@name='SwingBottomInAnimationAdapter' and count(parameter)=2 and parameter[1][@type='android.widget.BaseAdapter'] and parameter[2][@type='long']]"
		[Register (".ctor", "(Landroid/widget/BaseAdapter;J)V", "")]
		public SwingBottomInAnimationAdapter (global::Android.Widget.BaseAdapter p0, long p1) : base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			if (Handle != IntPtr.Zero)
				return;
		...
		public SwingBottomInAnimationAdapter (global::Android.Widget.BaseAdapter p0, long p1, long p2) : base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			if (Handle != IntPtr.Zero)
				return;
