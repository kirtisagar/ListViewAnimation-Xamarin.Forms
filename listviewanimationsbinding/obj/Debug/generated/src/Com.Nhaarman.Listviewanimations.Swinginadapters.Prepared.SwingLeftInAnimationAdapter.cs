...
namespace Com.Nhaarman.Listviewanimations.Swinginadapters.Prepared {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='com.nhaarman.listviewanimations.swinginadapters.prepared']/class[@name='SwingLeftInAnimationAdapter']"
	[global::Android.Runtime.Register ("com/nhaarman/listviewanimations/swinginadapters/prepared/SwingLeftInAnimationAdapter", DoNotGenerateAcw=true)]
	public partial class SwingLeftInAnimationAdapter : global::Com.Nhaarman.Listviewanimations.Swinginadapters.SingleAnimationAdapter {

		internal static new IntPtr java_class_handle;
		internal static new IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("com/nhaarman/listviewanimations/swinginadapters/prepared/SwingLeftInAnimationAdapter", ref java_class_handle);
			}
		}
		...
		protected override global::System.Type ThresholdType {
			get { return typeof (SwingLeftInAnimationAdapter); }
		}

		protected SwingLeftInAnimationAdapter (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer) {}

		static IntPtr id_ctor_Landroid_widget_BaseAdapter_;
		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.nhaarman.listviewanimations.swinginadapters.prepared']/class[@name='SwingLeftInAnimationAdapter']/constructor[@name='SwingLeftInAnimationAdapter' and count(parameter)=1 and parameter[1][@type='android.widget.BaseAdapter']]"
		[Register (".ctor", "(Landroid/widget/BaseAdapter;)V", "")]
		public SwingLeftInAnimationAdapter (global::Android.Widget.BaseAdapter p0) : base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			if (Handle != IntPtr.Zero)
				return;

			if (GetType () != typeof (SwingLeftInAnimationAdapter)) {
				SetHandle (
		...
		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.nhaarman.listviewanimations.swinginadapters.prepared']/class[@name='SwingLeftInAnimationAdapter']/constructor[@name='SwingLeftInAnimationAdapter' and count(parameter)=2 and parameter[1][@type='android.widget.BaseAdapter'] and parameter[2][@type='long']]"
		[Register (".ctor", "(Landroid/widget/BaseAdapter;J)V", "")]
		public SwingLeftInAnimationAdapter (global::Android.Widget.BaseAdapter p0, long p1) : base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			if (Handle != IntPtr.Zero)
				return;
		...
		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.nhaarman.listviewanimations.swinginadapters.prepared']/class[@name='SwingLeftInAnimationAdapter']/constructor[@name='SwingLeftInAnimationAdapter' and count(parameter)=3 and parameter[1][@type='android.widget.BaseAdapter'] and parameter[2][@type='long'] and parameter[3][@type='long']]"
		[Register (".ctor", "(Landroid/widget/BaseAdapter;JJ)V", "")]
		public SwingLeftInAnimationAdapter (global::Android.Widget.BaseAdapter p0, long p1, long p2) : base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			if (Handle != IntPtr.Zero)
				return;
